...
<ul>
    <li><a href="http://localhost:9999/connect?destination=<?php echo $url?>>&apiKey=f3527f1c-210f-4075-99d3-ece98cf2b391">Connect</a></li>
    <li><a href="http://localhost:9999/logout?destination=<?php echo $url?>&apiKey=f3527f1c-210f-4075-99d3-ece98cf2b391">Logout</a></li>
...
if (!empty($_SESSION)) {
    ...
    foreach ($_SESSION as $key => $value) {
        echo '<tr><td>' . htmlspecialchars($key) . '</td><td>' . $value . '</td></tr>';
    }
    echo '</table>';
}