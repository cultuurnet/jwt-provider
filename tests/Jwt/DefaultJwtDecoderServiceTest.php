...
class DefaultJwtDecoderServiceTest extends TestCase
{
    private string $tokenString;
    private array $tokenHeaders;
    private array $tokenClaimsAsValueObjects;
    ...
    private JwtDecoderService $decoderService;

    public function setUp(): void
    {
        $publicKeyString = file_get_contents(__DIR__ . '/samples/public.pem');
        ...
        $this->publicKey = new Key($publicKeyString);
        ...
        $this->decoderService = new DefaultJwtDecoderService(
            $this->parser,
            $this->validationData,
            $this->signer,
            $this->publicKey,
    ...
    {
        $actualToken = $this->decoderService->parse($this->tokenString);
    ...
    {
        $decoderWithoutRequiredClaims = new DefaultJwtDecoderService(
            $this->parser,
            $this->validationData,
            $this->signer,
            $this->publicKey
